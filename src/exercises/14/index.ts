...
export type ApiRoute<T extends string> = unknown;

export type ApiRouteWithId<T extends string> = unknown;

export type HttpMethod = unknown;

export type ApiEndpoint<M extends string, T extends string> = unknown;

export type EntityEvent<Entity extends string, Action extends string> = unknown;

export type AllEndpointsFor<T extends string> = unknown;

// Bonus:
export type UppercaseEvent<T extends string> = unknown;
