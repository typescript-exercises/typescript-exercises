...
export type UserStatistics = Record<string, number>;

export type BasicPersonInfo = Pick<Person, 'name' | 'age'>;

export type PersonType = Person['type'];

export type NonTypePersonKeys = Exclude<keyof Person, 'type'>;

// Bonus:
export type AdminOnlyKeys = Exclude<keyof Admin, keyof User>;
