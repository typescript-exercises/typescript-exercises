...
export type NotificationContact<T> = T extends Admin ? 'sms' : T extends User ? 'email' : never;

export type ResponseData<T> = T extends null | undefined ? 'No data available' : T;

export type UnwrapPromise<T> = T extends Promise<infer U> ? U : T;

export type IsAdmin<T> = T extends Admin ? true : false;
