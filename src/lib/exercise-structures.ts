...
export const exerciseStructures: Record<string, FileTree> = {
    ...
    11: {
        '/index.ts': {
            ...
            solution: require('!!raw-loader!../exercises/12/index.solution.ts').default
        },
        '/test.ts': {
    ...
    12: {
        '/index.ts': {
            ...
            solution: require('!!raw-loader!../exercises/13/index.solution.ts').default
        },
        '/test.ts': {
    ...
    14: {
        ...
        '/declarations/str-utils/index.d.ts': {
            content: require('!!raw-loader!../exercises/15/declarations/str-utils/index.d.ts').default,
            solution: require('!!raw-loader!../exercises/15/declarations/str-utils/index.solution.d.ts').default
        },
        '/node_modules/str-utils/index.js': {
            content: require('!!raw-loader!../exercises/15/node_modules/str-utils/index.js').default,
            readOnly: true
        },
        '/node_modules/str-utils/package.json': {
            content: formatJson(require('../exercises/15/node_modules/str-utils/package.json')),
            readOnly: true
        },
        '/node_modules/str-utils/README.md': {
            content: require('!!raw-loader!../exercises/15/node_modules/str-utils/README.md').default,
            readOnly: true
        },
        ...typeAssertions
    },
    15: {
        ...
        '/declarations/stats/index.d.ts': {
            content: require('!!raw-loader!../exercises/16/declarations/stats/index.d.ts').default,
            solution: require('!!raw-loader!../exercises/16/declarations/stats/index.solution.d.ts').default
        },
        '/node_modules/stats/index.js': {
            content: require('!!raw-loader!../exercises/16/node_modules/stats/index.js').default,
            readOnly: true
        },
        '/node_modules/stats/package.json': {
            content: formatJson(require('../exercises/16/node_modules/stats/package.json')),
            readOnly: true
        },
        '/node_modules/stats/README.md': {
            content: require('!!raw-loader!../exercises/16/node_modules/stats/README.md').default,
            readOnly: true
        },
        ...typeAssertions
    },
    ...
    17: {
        ...
        '/module-augmentations/date-wizard/index.d.ts': {
            content: require('!!raw-loader!../exercises/18/module-augmentations/date-wizard/index.ts').default,
            solution: require('!!raw-loader!../exercises/18/module-augmentations/date-wizard/index.solution.ts').default
        },
        '/node_modules/date-wizard/index.js': {
            content: require('!!raw-loader!../exercises/18/node_modules/date-wizard/index.js').default,
            readOnly: true
        },
        '/node_modules/date-wizard/index.d.ts': {
            content: require('!!raw-loader!../exercises/18/node_modules/date-wizard/index.d.ts').default,
            readOnly: true
        },
        '/node_modules/date-wizard/package.json': {
            content: formatJson(require('../exercises/18/node_modules/date-wizard/package.json')),
            readOnly: true
        },
        ...typeAssertions
    },
    ...
    21: {
        '/index.ts': {
            content: require('!!raw-loader!../exercises/22/index.ts').default,
            readOnly: true
        },
        '/test.ts': {
            content: require('!!raw-loader!../exercises/22/test.ts').default,
            readOnly: true
        }
    }
};
